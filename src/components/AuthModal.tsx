    ...
    >
      ...
      >
        <div className="relative w-full rounded-[23px] bg-[#090c15]/95 p-4 sm:p-5 backdrop-blur-xl overflow-y-auto max-h-[82vh] custom-scrollbar touch-pan-y pointer-events-auto">
          ...
          {mode !== 'edit' && (
            <div className="flex rounded-2xl bg-black/40 p-1 my-3 border border-white/10 relative z-10 backdrop-blur-md">
              <button
                type="button"
          ...
          {mode !== 'edit' && (
            <div className="mb-3 relative z-10">
              <button
                ...
                disabled={loading}
                className="w-full py-2.5 px-4 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs shadow-md transition-all flex items-center justify-center gap-2 border border-slate-200"
              >
              ...
              <div className="relative my-3 flex items-center justify-center">
                ...
                <span className="relative bg-[#090c15] px-2 text-[10px] uppercase tracking-wider text-slate-500 font-bold">OR FORM SIGNUP</span>
              </div>
            </div>
          )}
